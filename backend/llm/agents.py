...
class DatingAnalyzer(LLMClient):
    ...
    def __init__(self):
        ...
        super().__init__(dating_analyzer_system_instruction)
...
class GeneralDatingAdvisor(LLMClient):
    ...
    def __init__(self):
        ...
        super().__init__(general_dating_advisor_system_instruction)
        self.history: List[Dict[str, str]] = []
...
if __name__ == "__main__":
    # Иницализируем агентов
    analyzer = DatingAnalyzer()
    advisor = GeneralDatingAdvisor()
    ...
    print('AHAHHAHAHAHAHHAHAHAHAHAHAHAHAHAHAHA')
