...
class MessageReplyAdvisor:
    def suggest_reply(self, conversation_history: list, last_message: str) -> str:
        ...
        Дай короткий совет (1-2 предложения), как парню лучше ответить на это сообщение, чтобы произвести хорошее впечатление.
        Напиши только сам совет, без пояснений. На русском.
        """
